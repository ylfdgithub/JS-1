package com.benjaminwan.pytorchOCR;
...
public class PytorchOCRUtil {
    static String DET_PATH = "/demo/ptmodels/ch_ptocr_det_infer.pt";
    static String REC_PATH = "/demo/ptmodels/ch_ptocr_rec_infer.pt";
    /**
     * DET模型构建
     */
