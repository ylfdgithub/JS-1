...
//                String key= PytorchOCRUtil.ocr(resultPath+"/"+entry.getKey()+"/"+entry.getKey()+"-part-"+entry.getValue().get(i)[0]+".jpg");
//                String value =null;
//                if(entry.getValue().get(i)[1]==-1){
//                    value = "-1";
//                }
//                else{
//                    value= PytorchOCRUtil.ocr(resultPath+"/"+entry.getKey()+"/"+entry.getKey()+"-part-"+entry.getValue().get(i)[1]+".jpg");
//                }
//                map.put(key,value);
//                list1.add(key);
//                restBean.setMap(map);
